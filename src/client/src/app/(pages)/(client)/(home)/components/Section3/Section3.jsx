    ...
    <div className="container mx-auto mb-[60px] relative">
      ...
      <div className="absolute bottom-0 flex justify-between">
        ...
        <div className="w-1/3 mr-[85px] flex flex-col items-end">
          <div className="text-[52px] font-bold text-[var(--main-color)]">Thêm Một Bạn</div>
          <div className="text-[36px] font-bold text-[var(--main-color)]">Thêm Ngàn Niềm Vui!</div>
          ...
          {/* <div className="mt-[34px] flex items-center gap-[18px]">
            <Button
              className="bg-transparent text-[#002A48] hover:bg-[#80808023] border-[1.5px] border-[var(--main-color)] rounded-[57px] py-3 px-7"
            >
              Giới thiệu
              <CirclePlay />
            </Button>
            <Button className="bg-[var(--main-color)] hover:bg-[#012640] rounded-[57px] py-3 px-7">Khám phá ngay</Button>
          </div> */}
        </div>
      </div>
    </div>
